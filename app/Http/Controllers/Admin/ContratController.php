...
class ContratController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.contrat.create', ['contrat'=>$contrats]);
    }
    public function changerEtatAuto($id,Request $request)
    {
           ...
           if($contrat)
           {
            ...
            $contrat->update();
            return redirect()->route('admin.contrat.index');
      }
    }
    ...
    
    {
        ...
        if(isset($request->referance))
        $data['referance'] = 'required';
        if(isset($request->date_cheq))
        $data['date_cheq'] = 'required';
        ...
        return redirect()->route('admin.contrats.index')->with('successMsg','Contrat Successfully Saved');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.contrats.index')->with('successMsg','Contrat Successfully updated');
    }

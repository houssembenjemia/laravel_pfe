                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                                ...
                                                @endif
                                                 ...
                                                 <td>
                                                <a href="{{ route('admin.contrats.edit',$contrat->id) }}" class="btn btn-info btn-sm"><i class="material-icons">mode_edit</i></a>
                                                <a href="{{ route('admin.contrats.show',$contrat->id) }}" class="btn btn-info btn-sm"><i class="material-icons">details</i></a>
                                                <form id="delete-form-{{ $contrat->id }}" action="{{ route('admin.contrats.destroy',$contrat->id) }}" style="display: none;" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>

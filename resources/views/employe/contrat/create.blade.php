                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <form method="POST" action="{{ route('employe.contrats.store') }}"
                                ...
                                <div class="col-md-12">
                                    <div class=" form-group col-md-4">
                                        ...
                                        <div class="col-10 {{ $errors->has('date_prime') ? ' has-error' : '' }}">
                                            <input type="date" name="date_prime" value="{{old('date_prime')}}"
                                    ...
                                    <div class=" form-group col-md-4">
                                        ...
                                        <div class="col-10 {{ $errors->has('prime_tot') ? ' has-error' : '' }}">
                                            <input type="text" name="prime_tot" value="{{old('prime_tot')}}"
                                                   placeholder="Entrer la prime totale" class="form-control name_list"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">

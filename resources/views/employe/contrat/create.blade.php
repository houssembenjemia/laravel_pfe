            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form method="POST" action="{{ route('employe.contrats.store') }}" enctype="multipart/form-data">
                                @csrf
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class=" col-md-12">
                                ...
                                <div class="form-group col-md-3 {{ $errors->has('date_debut') ? ' has-error' : '' }} ">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control" type="date" name="date_debut" value="{{old('date_debut')}}"id="example-url-input">
                                ...
                                <div class="form-group col-md-3 {{ $errors->has('date_fin') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control" type="date" value="{{old('date_fin')}}"name="date_fin" id="date_fin">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group col-md-3 {{ $errors->has('immatriculation') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-10">
                                    <input class="form-control" type="text" value="{{old('immatriculation')}}" name="immatriculation" >
                                ...
                                <div class="form-group col-md-3 {{ $errors->has('image') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control img-file" type="file" value="{{old('image')}}" name="image" >
                                        @if ($errors->has('image'))
                                        <span class="help-block">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class=" form-group col-md-4">
                                    ...
                                    <div class="col-10 {{ $errors->has('date_prime') ? ' has-error' : '' }}">
                                        <input type="date" name="date_prime" value="{{old('date_prime')}}" placeholder="Enter your date" class="form-control name_list" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-4  {{ $errors->has('commision') ? ' has-error' : ''  }}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="commision" id="inputGroupSuccess3" value="{{old('commision')}}" aria-describedby="inputGroupSuccess3Status">
                                    </div>
                                ...
                                <div class=" form-group col-md-4">
                                        ...
                                        <div class="col-10 {{ $errors->has('prime_tot') ? ' has-error' : '' }}">
                                            <input type="text" name="prime_tot" value="{{old('prime_tot')}}" placeholder="Entrer la prime totale" class="form-control name_list" />
                                        </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class=" form-group col-md-4">
                                        ...
                                        <div class="col-10 {{ $errors->has('montant') ? ' has-error' : '' }}">
                                            <input type="text" name="montant" value="{{old('montant')}}" placeholder="Entrer le montant" class="form-control name_list" />
                                        </div>
                                </div>
                                ...
                                <div class=" form-group col-md-4">
                                        ...
                                        <div class="col-10 {{ $errors->has('referance') ? ' has-error' : '' }}">
                                            <input type="text" name="referance" value="{{old('referance')}}" placeholder="Enter la référence" class="form-control name_list" />
                                        </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class=" form-group col-md-4">
                                        ...
                                        <div class="col-10 {{ $errors->has('date_cheq') ? ' has-error' : '' }}">
                                            <input type="date" name="date_cheq" value="{{old('date_cheq')}}" placeholder="Entrer une date" class="form-control name_list" />
                                        </div>
                                </div>
                                ...
                                <div class=" form-group col-md-4">
                                        ...
                                        <div class="col-10 {{ $errors->has('banque') ? ' has-error' : '' }}">
                                            <input type="text" name="banque" value="{{old('banque')}}" placeholder="Entrer la banque" class="form-control name_list" />
                                        </div>
                                </div>

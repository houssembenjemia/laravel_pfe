...
@section('content')
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="{{ route('employe.contrats.create') }}">2Roues/ 3Roues</a></li>
      <li><a href="{{ route('employe.contrats.create') }}">Véhicule ou autres</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                                ...
                                                @endif
                                                 ...
                                                 <td>
                                                <a href="{{ route('employe.contrats.edit',$contrat->id) }}" class="btn btn-info btn-sm"><i class="material-icons">mode_edit</i></a>
                                                <a href="{{ route('employe.contrats.show',$contrat->id) }}" class="btn btn-info btn-sm"><i class="material-icons">details</i></a>
                                                <form id="delete-form-{{ $contrat->id }}" action="{{ route('employe.contrats.destroy',$contrat->id) }}" style="display: none;" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>

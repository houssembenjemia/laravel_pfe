                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="list-group-item  "><span style="float: left">Identité :&nbsp </span> <span
                                        style="right: left">@if($contrat->client->identite != "") {{$contrat->client->identite}}
                                    @else -
                                    @endif</span></div>
                            <div class="list-group-item "><span
                                        style="float: left">CIN :&nbsp </span>@if($contrat->client->cin != "") {{$contrat->client->cin}}
                                @else -
                                @endif</div>
                            <div class="list-group-item "><span
                                        style="float: left">Téléphone :&nbsp </span>@if($contrat->client->tel != "") {{$contrat->client->tel}}
                                @else -
                                @endif</div>
                            <div class="list-group-item "><span
                                        style="float: left">Adresse :&nbsp </span>@if($contrat->client->adresse != "") {{$contrat->client->adresse}}
                                @else -
                                @endif</div>
                        </div>
                        <div class="card-content">

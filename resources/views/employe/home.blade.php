                    ...
                    <div class="card">
                        ...
                        <div class="card-content table-responsive">
                            <table width="40%" align=center border=1>
                                <TR>
                                    <TD><a href="{{ route('employe.contrats.create') }}"><img
                                ...
                                <TR>
                                    <TD><a href="{{ route('employe.contrats.create') }}"><img
                                                    src="/backend/images/Gat.png" align=center/></a></TD>
                                    <TD><a href="{{ route('employe.contrats.create') }}"><img
                                                    src="/backend/images/Magh.png" align=center/></a></TD>
                                    <TD><a href="{{ route('employe.contrats.create') }}"><img
                                                    src="/backend/images/Salim.png" align=center/></a></TD>
                                </TR>
                                <TR>
                                    <TD><a href="{{ route('employe.contrats.create') }}"><img
                                                    src="/backend/images/Star.png" align=center/></a></TD>
                                </TR>
                            </table>
                        </div>
                    </div>

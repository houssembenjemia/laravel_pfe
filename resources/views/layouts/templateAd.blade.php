				 ...
				 @if (Auth::user()->role=="admin")
        			<ul class="nav">
            				<li @if(Route::current()->getName() == 'admin.home') class="active" @endif >
                				<a href="http://127.0.0.1:8000/admin/home"><i class="material-icons">dashboard</i><p>Dashboard</p></a>
            				</li>
                            <li @if(Route::current()->getName() == 'admin.contrats.index') class="active" @endif >
                				<a href="http://127.0.0.1:8000/admin/contrats"><i class="fas fa-file"></i><p>Contrats</p></a>
            				</li>
            				<li @if(Route::current()->getName() == 'admin.clients.index') class="active" @endif >
                				<a href="http://127.0.0.1:8000/admin/clients"><i class="far fa-user"></i><p>Clients</p></a>
            				</li>
            				<li @if(Route::current()->getName() == 'admin.clients.index') class="active" @endif >
                				<a href="http://127.0.0.1:8000/admin/comptablite"><i class="material-icons">library_books</i><p>Comptablites</p></a>
            				</li>
  			               
            				<li @if(Route::current()->getName() == 'admin.employes.index') class="active" @endif >
                				<a href="http://127.0.0.1:8000/admin/employes"><i class="material-icons">message</i><p>Employes</p></a>
            				</li>
                            <li @if(Route::current()->getName() == 'admin.contacts.index') class="active" @endif >
                				<a href="http://127.0.0.1:8000/admin/contacts"><i class="far fa-comment-dots"></i><p>Contacts</p></a>
            				</li>
				</ul>
				 @elseif (Auth::user()->role=="employe")
				<ul class="nav">
            				<li class="active">
                				<a href="http://127.0.0.1:8000/employe/home"><i class="material-icons">dashboard</i><p>Dashboard</p></a>
            				</li>
                            <li class="">
                				<a href="http://127.0.0.1:8000/employe/contrats"><i class="fas fa-file"></i><p>Contrats</p></a>
            				</li>
            				<li class="">
                				<a href="http://127.0.0.1:8000/employe/clients"><i class="far fa-user"></i><p>Clients</p></a>
            				</li>
				</ul>
				 @elseif (Auth::user()->role=="client")
				<ul class="nav">
            				<li class="active">
                				<a href="http://127.0.0.1:8000/admin/dashboard"><i class="material-icons">dashboard</i><p>Dashboard</p></a>
            				</li>
                            <li class="">
                				<a href="http://127.0.0.1:8000/client/contrats"><i class="far fa-user"></i><p>Consulter contrats</p></a>
            				</li>
				</ul>
                @endif
